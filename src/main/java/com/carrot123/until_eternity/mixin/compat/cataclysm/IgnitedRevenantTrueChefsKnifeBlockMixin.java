...
@Pseudo
@Mixin(
        targets = "com.github.L_Ender.cataclysm.entity.AnimationMonster.BossMonsters.Ignited_Revenant_Entity",
        remap = false)
public abstract class IgnitedRevenantTrueChefsKnifeBlockMixin {
    @ModifyExpressionValue(
            ...
            at = @At(
                    value = "INVOKE",
                    target = "Lcom/github/L_Ender/cataclysm/entity/AnimationMonster/BossMonsters/Ignited_Revenant_Entity;canBlockDamageSource(Lnet/minecraft/world/damagesource/DamageSource;)Z",
                    remap = false),
            remap = false,
            require = 1)
