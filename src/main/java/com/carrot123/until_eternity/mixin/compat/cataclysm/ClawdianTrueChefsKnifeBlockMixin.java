...
@Pseudo
@Mixin(
        targets = "com.github.L_Ender.cataclysm.entity.InternalAnimationMonster.AcropolisMonsters.Clawdian_Entity",
        remap = false)
public abstract class ClawdianTrueChefsKnifeBlockMixin {
    @ModifyExpressionValue(
            ...
            at = @At(
                    value = "INVOKE",
                    target = "Lcom/github/L_Ender/cataclysm/entity/InternalAnimationMonster/AcropolisMonsters/Clawdian_Entity;canBlockDamageSource(Lnet/minecraft/world/damagesource/DamageSource;)Z",
                    remap = false),
            remap = false,
            require = 1)
