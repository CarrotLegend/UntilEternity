...
@Pseudo
@Mixin(
        targets = "com.github.L_Ender.cataclysm.entity.InternalAnimationMonster.Draugar.Royal_Draugr_Entity",
        remap = false)
public abstract class RoyalDraugrTrueChefsKnifeBlockMixin {
    @ModifyExpressionValue(
            ...
            at = @At(
                    value = "INVOKE",
                    target = "Lcom/github/L_Ender/cataclysm/entity/InternalAnimationMonster/Draugar/Royal_Draugr_Entity;canBlockDamageSource(Lnet/minecraft/world/damagesource/DamageSource;)Z",
                    remap = false),
            remap = false,
            require = 1)
