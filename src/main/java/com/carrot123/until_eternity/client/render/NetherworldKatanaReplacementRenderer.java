...
public final class NetherworldKatanaReplacementRenderer {
    ...
    public static void render(ItemStack stack, PoseStack poseStack,
        ...
        try {
            ...
            // Preserve the root-space transform used by EEEAB's original model.
            poseStack.translate(-0.5F / 16.0F, 22.0F / 16.0F, 1.0F / 16.0F);
            poseStack.mulPose(new Quaternionf().rotationZYX(
                    -3.1416F, 0.0F, -1.5708F));
